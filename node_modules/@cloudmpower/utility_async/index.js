(function(){
    ...
    let paperwork = require('./lib/paperwork');

    let timestamp = require('./lib/timestamp');

    let logger = require('@cloudmpower/logger_async');

    let errorResponse = require("@cloudmpower/errorresponse_async")();

    let successResponse = require("@cloudmpower/successresponse_async")();
    ...
    module.exports.getEasyPassword = (len) => {
        let leng = (typeof len == "number")? len : 6;
        let text = "";
    ...
    module.exports.paperwork = paperwork;
